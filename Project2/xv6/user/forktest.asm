...
forktest(void)
{
  ...
  3e:	42650513          	addi	a0,a0,1062 # 460 <getpinfo+0xa>
  ...
  68:	40c50513          	addi	a0,a0,1036 # 470 <getpinfo+0x1a>
  ...
  b8:	40c50513          	addi	a0,a0,1036 # 4c0 <getpinfo+0x6a>
  ...
  d4:	3c050513          	addi	a0,a0,960 # 490 <getpinfo+0x3a>
  ...
  ee:	3be50513          	addi	a0,a0,958 # 4a8 <getpinfo+0x52>
